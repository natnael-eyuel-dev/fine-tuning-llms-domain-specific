...
We fine-tune a biomedical Transformer encoder (PubMedBERT) on a **biomedical domain** dataset (`OxAISH-AL-LLM/pubmed_20k_rct`) for **section classification**.

- **Baseline**: TF‑IDF + Logistic Regression
- **Fine-tuned model**: `microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext` (Hugging Face `Trainer`)
